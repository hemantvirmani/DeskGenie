...
class MyGAIAAgents:
    ...
    def __call__(self, question: str, file_name: str = None, chat_history: list = None, episodic_context: str = None) -> str:
        ...
        """
        return self.agent(question, file_name, chat_history=chat_history, episodic_context=episodic_context)
